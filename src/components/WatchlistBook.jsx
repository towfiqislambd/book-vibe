...
const WatchlistBook = ({ wishBook }) => {
    const { bookId, image, bookName, author, rating, category, tags, totalPages, publisher, yearOfPublishing } = wishBook;
    return (
        <div className="lg:grid grid-cols-3 gap-10 items-center border p-5">
